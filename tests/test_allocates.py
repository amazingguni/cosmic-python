...
from core.models import Batch, OrderLine, allocate, OutOfStock
...
def test_prefers_earlier_batches():
    ...
    ret_reference = allocate(line, [earliest, medium, earliest])

    assert earliest.reference == ret_reference
